...
paths:
            ...
            schema:
              ...
              properties:
                file:
                  ...
                  format: binary
                volume:
                  $ref: '#/components/schemas/CoverVolume' 
                description:
                  type: string
                  nullable: false
                locale:
  ...
  /admin/sync:
    get:
      summary: Trigger a full Manga sync
      description: "Triggers the DataLoader to fetch all manga from MangaDex."
      responses:
        '200':
    ...
    ChapterRequest:
      ...
      properties:
        title:
          ...
          nullable: true
        volume:
          $ref: '#/components/schemas/ChapterVolume'
        chapter:
          $ref: '#/components/schemas/ChapterVolume'
        translatedLanguage:
          type: string
